...
func MergeHttpPolicies(
	...
	mergeFuncs := []func(string, *HttpListenerPolicyIr, *HttpListenerPolicyIr, *ir.AttachedPolicyRef, ir.MergeOrigins, policy.MergeOptions, ir.MergeOrigins){
		...
		mergeResponseCompressionCodecPreference,
	}
...
func mergeResponseCompressionCodecPreference(
	origin string,
	p1, p2 *HttpListenerPolicyIr,
	p2Ref *ir.AttachedPolicyRef,
	p2MergeOrigins ir.MergeOrigins,
	...
	if !policy.IsMergeable(p1.responseCompressionCodecPreference, p2.responseCompressionCodecPreference, opts) {
		return
	}

	p1.responseCompressionCodecPreference = slices.Clone(p2.responseCompressionCodecPreference)
	mergeOrigins.SetOne(origin+"responseCompressionCodecPreference", p2Ref, p2MergeOrigins)
}
