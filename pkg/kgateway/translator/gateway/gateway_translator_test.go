...
func TestBasic(t *testing.T) {
	...
	t.Run("TrafficPolicy with compression content-type and min-length", func(t *testing.T) {
		test(t, translatorTestCase{
			...
			outputFile: "traffic-policy/compression-content-type-min-length-route.yaml",
			gwNN: types.NamespacedName{
				Namespace: "default",
				Name:      "example-gateway",
			},
	...
	t.Run("TrafficPolicy with compression min-length only keeps default content types", func(t *testing.T) {
		test(t, translatorTestCase{
			inputFiles: []string{"traffic-policy/compression-min-length-route.yaml"},
			outputFile: "traffic-policy/compression-min-length-route.yaml",
			gwNN: types.NamespacedName{
				Namespace: "default",
				Name:      "example-gateway",
			},
	...
	t.Run("TrafficPolicy compression per-route settings get distinct filters", func(t *testing.T) {
		test(t, translatorTestCase{
			inputFiles: []string{"traffic-policy/compression-per-route-settings.yaml"},
			outputFile: "traffic-policy/compression-per-route-settings.yaml",
			gwNN: types.NamespacedName{
				Namespace: "default",
				Name:      "example-gateway",
			},
	...
	t.Run("TrafficPolicy timeout targeting whole Gateway (HTTP and HTTPS listeners)", func(t *testing.T) {
		test(t, translatorTestCase{
			inputFiles: []string{"traffic-policy/timeout-gateway-whole.yaml"},
			outputFile: "traffic-policy/timeout-gateway-whole.yaml",
			gwNN: types.NamespacedName{
				Namespace: "default",
				Name:      "example-gateway",
			},
	...
	t.Run("TrafficPolicy timeout targeting Gateway HTTP listener", func(t *testing.T) {
		test(t, translatorTestCase{
			inputFiles: []string{"traffic-policy/timeout-gateway-http-listener.yaml"},
			outputFile: "traffic-policy/timeout-gateway-http-listener.yaml",
			gwNN: types.NamespacedName{
				Namespace: "default",
				Name:      "example-gateway",
			},
	...
	t.Run("TrafficPolicy timeout targeting Gateway HTTPS listener", func(t *testing.T) {
		test(t, translatorTestCase{
			inputFiles: []string{"traffic-policy/timeout-gateway-https-listener.yaml"},
			outputFile: "traffic-policy/timeout-gateway-https-listener.yaml",
			gwNN: types.NamespacedName{
				Namespace: "default",
				Name:      "example-gateway",
			},
